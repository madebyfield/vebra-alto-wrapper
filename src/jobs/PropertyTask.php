 ...
 *
 * use madebyfield\vebraaltowrapper\jobs\PropertTask as PropertTaskJob;
 *
 * $queue = Craft::$app->getQueue();
 * $jobId = $queue->push(new PropertTaskJob([
 ...
 * @since     1.1.0
 */
class PropertyTask extends BaseJob
{
    // Public Properties
    // =========================================================================
    ...
    public function execute($queue): void
    {
        ...
        $property = VebraAltoWrapper::getInstance()->vebraAlto->connect($this->url)['response'];
    ...
    {
        return Craft::t('vebra-alto-wrapper', 'Syncing property ' . $this->title);
    }
}
