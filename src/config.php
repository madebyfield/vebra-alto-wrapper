...
/**
 * Vebra Alto Wrapper config.php
 *
 * This file exists only as a template for the Vebra Alto Wrapper settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'vebra-alto-wrapper.php'
